...
const getDepartment = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ success: true, error: "get department server error" });
  }
};
...
const updateDepartment = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ success: true, error: "Edit department server error" });
  }
};
const deleteDepartment =async (req,res) => {
  try {
    ...
    return res
      .status(500)
      .json({ success: true, error: "Delete department server error" });
  }
};
